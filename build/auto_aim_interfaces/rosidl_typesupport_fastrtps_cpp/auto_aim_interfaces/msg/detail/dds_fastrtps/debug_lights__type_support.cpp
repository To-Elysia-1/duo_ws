  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: data
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      auto_aim_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.data[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        auto_aim_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.data[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        auto_aim_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_key_DebugLight(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
