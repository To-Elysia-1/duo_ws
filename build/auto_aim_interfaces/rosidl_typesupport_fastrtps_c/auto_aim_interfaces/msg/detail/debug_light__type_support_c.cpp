  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const auto_aim_interfaces__msg__DebugLight * ros_message = static_cast<const auto_aim_interfaces__msg__DebugLight *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_auto_aim_interfaces__msg__DebugLight(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  auto_aim_interfaces__msg__DebugLight * ros_message = static_cast<auto_aim_interfaces__msg__DebugLight *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_auto_aim_interfaces__msg__DebugLight(cdr, ros_message);
}
