  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xa0, 0x68, 0x36, 0x1e, 0x5b, 0xdb, 0x9c, 0xc3,
      0x19, 0x26, 0xf5, 0x21, 0x62, 0x0e, 0x68, 0x43,
      0xc2, 0x72, 0xc2, 0x17, 0x5e, 0x89, 0xb4, 0x08,
      0xd0, 0x94, 0x3c, 0xea, 0x09, 0x58, 0x9b, 0x28,
    }};
  return &hash;
}
...
#ifndef NDEBUG
static const rosidl_type_hash_t auto_aim_interfaces__msg__Armor__EXPECTED_HASH = {1, {
...
static char auto_aim_interfaces__msg__Armors__TYPE_NAME[] = "auto_aim_interfaces/msg/Armors";
...
static char auto_aim_interfaces__msg__Armors__FIELD_NAME__header[] = "header";
static char auto_aim_interfaces__msg__Armors__FIELD_NAME__armors[] = "armors";

static rosidl_runtime_c__type_description__Field auto_aim_interfaces__msg__Armors__FIELDS[] = {
  {
    {auto_aim_interfaces__msg__Armors__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {auto_aim_interfaces__msg__Armors__FIELD_NAME__armors, 6, 6},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription auto_aim_interfaces__msg__Armors__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {auto_aim_interfaces__msg__Armor__TYPE_NAME, 29, 29},
    {NULL, 0, 0},
  },
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {auto_aim_interfaces__msg__Armors__TYPE_NAME, 30, 30},
      {auto_aim_interfaces__msg__Armors__FIELDS, 2, 2},
    },
    {auto_aim_interfaces__msg__Armors__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
    assert(0 == memcmp(&auto_aim_interfaces__msg__Armor__EXPECTED_HASH, auto_aim_interfaces__msg__Armor__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[0].fields = auto_aim_interfaces__msg__Armor__get_type_description(NULL)->type_description.fields;
...
auto_aim_interfaces__msg__Armors__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *auto_aim_interfaces__msg__Armors__get_individual_type_description_source(NULL),
    sources[1] = *auto_aim_interfaces__msg__Armor__get_individual_type_description_source(NULL);
